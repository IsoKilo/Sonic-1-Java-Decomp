...
public final class Actor extends Game {
        ...
        for (int i = 0; i < 10; i++) {
            if (((Game) this).f258a[i][2] == 0) {
                if (((Game) this).f258a[i][3] == 0) {
                    ...
                    s = (short) ((this.f94S + ((Game) this).f96U) / 100);
                    s2 = (short) (((((Game) this).f95T + ((Game) this).f97V) / 100) + 24);
                }
                short s3 = s2;
    ...
    */
    private void m342aq() {
        ...
        int i = 0;
        int i2 = 0;
        int Actor_CheckPlayerCollide = 0;
        int[] iArr2 = new int[0];
        char c2;
        int i3 = 0;
        int[][] m225a = new int[0][0];
        int i4 = 0;
        int[][] m225a2 = new int[0][0];
        int i5 = 0;
        int i6 = -1;
        boolean z = false;
        ((Game) this).Object_Info[15] = ((Game) this).Object_Info[2];
    ...
    */
    private void m336aw() {
        ...
        int i5 = 0;
        int Actor_CheckPlayerCollide = 0;
        int Actor_CheckPlayerCollide2 = 0;
        int i6 = 8;
        int i7 = 0;
        int i8 = 0;
        int i9 = 0;
