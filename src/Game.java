...
public class Game extends Canvas implements Runnable, PlayerListener {
    ...
    /* renamed from: c */
    private static final int[][][] f216c = {new int[][]{new int[]{4, 0, 9407, 0, 768, 96}, new int[]{4, 0, 7871, 0, 768, 96}, new int[]{4, 0, 10592, 0, 768, 96}, new int[]{4, 0, 10943, 0, 768, 96}}, new int[0][0], new int[][]{new int[]{4, 0, 6079, 0, 464, 96}, new int[]{4, 0, 6079, 0, 1312, 96}, new int[]{4, 0, 6144, 0, 1824, 96}, new int[]{4, 0, 5823, 0, 1824, 96}}, new int[0][0], new int[][]{new int[]{4, 0, 8896, 0, 1056, 96}, new int[]{4, 0, 10432, 0, 1312, 96}, new int[]{4, 0, 11264, 0, 1568, 96}, new int[]{4, 0, 11968, 0, 1568, 96}}, new int[0][0]};
        ...
        switch (this.Menu_ID) {
            ...
            case 13:
                ...
                if (i28 < 7 && this.Menu_CurrentSelection + 2 > i28) {
                    b = (byte) ((this.Menu_CurrentSelection - i28) + 1);
                }
            ...
            if (this.f28aW != 1) {
                if (this.f28aW == 2) {
                    if (this.f29aX < 1) {
                        ...
                        s = (short) ((this.f29aX < 12 ? (this.f29aX >> 1) % 6 : 6 + ((this.f29aX - 12) % 4)) * 40);
                        s2 = 40;
                        i = 40;
                        i2 = 40;
                    }
